# Generated by Skyramp v1.3.16 on 2026-03-31 10:24:04.683924 +0000 UTC m=+244.651162213
...
# 		--overwrite \
# 		--parent-request-data order_id={"customer_email": "contract@mail.com", "items": [{"product_id": 1, "quantity": 1}]} \
...
def test_orders_order_id_patch():
    ...
    assert abs(skyramp.get_response_value(orders_order_id_PATCH_response, "discount_amount") - skyramp.get_response_value(orders_order_id_PATCH_response, "total_amount") * (skyramp.get_response_value(orders_order_id_PATCH_response, "discount_value") / 100)) < 0.01
